        ...
        if(e.getSource()==button){
            ...
            try {
                ...
                if (fileContents.contains(bname)) {
                    ...
                    JOptionPane.showMessageDialog(null, "Book Issued to you,Please return it in time", null, JOptionPane.PLAIN_MESSAGE);
                } 
                else {
                    JOptionPane.showMessageDialog(null, "Sorry Book is not available for now", null, JOptionPane.PLAIN_MESSAGE);
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            } 
