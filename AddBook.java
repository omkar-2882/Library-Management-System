...
public class AddBook implements ActionListener {
    ...
    JLabel hlabel = new JLabel("Add Book");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==button){
            ...
            try (FileWriter f1 = new FileWriter(f5,true); BufferedWriter b1 = new BufferedWriter(f1); PrintWriter p1 = new PrintWriter(b1);) 
            {
                p1.println(bname);
            } catch (IOException i) {
                i.printStackTrace();
            }
            JOptionPane.showMessageDialog(null, "Book Added Successfully!", null, JOptionPane.PLAIN_MESSAGE);
        }
...
class Allgenre3 implements ActionListener {
    ...
    Allgenre3(){
        ...
        public void actionPerformed(ActionEvent e) {
            if(e.getSource()==button1){
                new AddBook("biography.txt");
            }
            if(e.getSource()==button2){
                new AddBook("science and research.txt");
            }
            if(e.getSource()==button3){
                new AddBook("health and fitness.txt");
            }
            if(e.getSource()==button4){
                new AddBook("politics and law.txt");
            }
            if(e.getSource()==button5){
                new AddBook("environment.txt");
            }
            if(e.getSource()==hbutton){
                frame1.dispose();
                new AdminOptions();
